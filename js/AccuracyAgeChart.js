class AccuracyAgeChart {
    ...
    initVis() {
        ...
        for (let i = 0; i < vis.ringCount; i++) {
            ...
            vis.chartGroup.append("text")
                .attr("x", i !== 4 ? -1 * (vis.maxRadius - i * vis.ringThickness) + 10 : -1 * (vis.maxRadius - i * vis.ringThickness) + 25)
                .attr("y", 0)
                .attr("text-anchor", "start")
                .attr("alignment-baseline", "middle")
                .attr("fill", i % 2 === 0 ? "#ffffff" : "#c83737ff")
                .attr("font-size", "8px")
                .text(`${25 * (i)}%`);

            vis.chartGroup.append("text")
                .attr("x", (vis.maxRadius - i * vis.ringThickness) - 10)
                .attr("y", 0)
            ...
            vis.chartGroup.append("text")
                .attr("x", 0)
                .attr("y", -(vis.maxRadius - i * vis.ringThickness) + 16)
                .attr("text-anchor", "middle")
                .attr("alignment-baseline", "middle")
                .attr("fill", i % 2 === 0 ? "#ffffff" : "#c83737ff")
                .attr("font-size", "8px")
    ...
    updateVis() {
        ...
        vis.chartGroup.selectAll("text.accuracy-label").remove();
